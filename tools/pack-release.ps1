...
.PARAMETER Version
  Version label without leading v (e.g. 15.9.1). Default: BASTION_RELEASE_VERSION env or 15.9.1.
...
.EXAMPLE
  pwsh -File tools/pack-release.ps1 -Version 15.9.1
#>
[CmdletBinding()]
param(
  [string]$Version = $(if ($env:BASTION_RELEASE_VERSION) { $env:BASTION_RELEASE_VERSION } else { "15.9.1" }),
  [string]$OutputDir = "",
