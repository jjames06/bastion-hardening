...
4. Extract the zip to a location **you** control (for example `C:\Tools\`). Official zips expand to one folder such as `bastion-hardening-v15.9.9\` with the bootstrap, `src\` modules, and docs already together.  
