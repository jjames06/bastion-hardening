...
|----|-------|------|---------|--------|
| **Windows 11 Pro** | **10.0.26200** (build **26200**) | 64-bit | **v15.9.0** | GPLv3; modular plain-text `src\` modules + MANIFEST integrity; script-scope module load; modular Recovery hubs; encrypted DNS/RDP undo; Settings-matching DoH Encrypted; optional RdpHostLock; handbook/wiki; as of 2026-08-02 |
